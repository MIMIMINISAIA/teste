...
class SystemTest extends TestCase
{
    ...
    public function test_full_tarefa_crud(){
        ...
        //assertDatabaseHas: Este metodo verifica se há uma entrada especifica no banco de dados.
        ...
        //assertDatabaseMissing: este metodo verifica se nao há mais um determinado registro no banco de dados
